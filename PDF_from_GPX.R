## This script generates a PDF File out of a .gpx set of coordinates and data

## Original in http://lwlss.net/GarminReports/GarminFunctions.R  by 
## http://cnr.lwlss.net/GarminR/

## Several modifications have been made by Ricardo Chavelas  ( coments in ##R# )
###This file handles the readGPX function (readGPX.R)
